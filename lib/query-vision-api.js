...
function* queryVisionApi(
  ...
  if(!loopPreventor && isUnauthorized) {
    ...
    var optionssalesforce = {
      	url: 'http://einstein-vision-integrate-zbia.us-e1.cloudhub.io/create-interests',
      	method: 'POST',
      	headers: {
        ...
        'Cache-Control': 'no-cache'
      	...
      	formData:JSON.stringify(visionApiResult)
  	}

  	const response = yield Episode7.call(rp.post, optionssalesforce);
